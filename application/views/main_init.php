                ...
                <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown" onclick="javascript: dropOptions(this);">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark patients-options" \
                                aria-labelledby="navbarDarkDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="<?php echo base_url('/patients');?>">
                                        Listar todos
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo base_url('/patients-register-view');?>">
                                        Registrar
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown" onclick="javascript: dropOptions(this);">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark patients-options" \
                                aria-labelledby="navbarDarkDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="<?php echo base_url('/edit-doctor');?>">
                                        Perfil
                                    </a>
                                </li>
                                <li>
